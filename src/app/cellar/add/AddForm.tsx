...
export default function AddBottlePage({ ai }: { ai: { canIdentify: boolean; canEnrich: boolean } }) {
  ...
  return (
    <main style={{ maxWidth: 520, margin: "0 auto", padding: "var(--s-7) var(--s-5)" }}>
      ...
      {!ai.canIdentify && !ai.canEnrich && (
        <p style={{ marginTop: "var(--s-4)", fontSize: "var(--t-small)", color: "var(--ink-mute)" }}>
          <Link href="/settings">Configure tes clés IA dans Réglages</Link> pour l&apos;ajout par photo et l&apos;enrichissement.
        </p>
      )}
